...
function ul.System.Object:GetType()
	if self.__type == nil then
		self.__type = ul.System.Type.GetType_ul_System_String(ul.System.String.new(self.__cname))
	end
	return self.__type;
end
...
function ul.System.Object.op_Equality(a,b)
	return ul.System.Object.ReferenceEquals_ul_System_Object_ul_System_Object(a,b);
end

namespace System
{
    public struct Byte
    {
        ...
        public static implicit operator Single(Byte v);
        public static implicit operator Double(Byte v);
        public static implicit operator Int16(Byte v);
        public static explicit operator SByte(Byte v);
        public static explicit operator UInt16(Byte v);
        public static explicit operator UInt32(Byte v);
        public static explicit operator UInt64(Byte v);
    }
}
